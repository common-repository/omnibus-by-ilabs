 ...
 */
namespace Isolated\Omnibus_By_Ilabs\Composer;

use Isolated\Omnibus_By_Ilabs\Composer\Autoload\ClassLoader;
use Isolated\Omnibus_By_Ilabs\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Isolated\\Omnibus_By_Ilabs\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
